 ...
 * generated in the com.edms.user package. 
...
public class ObjectFactory {
    ...
    private final static QName _GetUserListRequest_QNAME = new QName("http://edms.com/User", "getUserListRequest");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.edms.user
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://edms.com/User", name = "getUserListRequest")
