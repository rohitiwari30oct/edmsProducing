 ...
 *         &lt;element name="versionsHistory" type="{http://edms.com/Folder}versionDetail" maxOccurs="unbounded" minOccurs="0"/>
...
public class Folder {
    ...
    protected List<VersionDetail> versionsHistory;
    ...
    /**
     * Gets the value of the versionsHistory property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the versionsHistory property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getVersionsHistory().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<VersionDetail> getVersionsHistory() {
        if (versionsHistory == null) {
            versionsHistory = new ArrayList<VersionDetail>();
        }
