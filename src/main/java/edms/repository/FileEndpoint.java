...
import com.edms.documentmodule.RemovePublicLinkRequest;
import com.edms.documentmodule.RemovePublicLinkResponse;
...
public class FileEndpoint {
	...
	@PayloadRoot(namespace = NAMESPACE_URI, localPart = "removePublicLinkRequest")
	@ResponsePayload
	public RemovePublicLinkResponse removePublicLinkRequest(@RequestPayload RemovePublicLinkRequest request) {
		RemovePublicLinkResponse response = new RemovePublicLinkResponse();
		response.setResponseMessage(FileRepository
				.removePublicLink(request.getFilePath(),request.getUserid(),request.getPassword(),request.getGuestid()));
		return response;
	}
