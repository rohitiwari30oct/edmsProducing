...
//* {@code SyncMBeanImpl}...
//*/
//public class CustomSyncClass  implements SynchronizationMBean {
//
//    /**
//     * default logger
//     */
...
//
//    public CustomSyncClass(Repository repository, SyncManager syncManager, String syncName,
...
//         */
//        @Nonnull
//        public String[] syncAllExternalUsers() throws RepositoryException, SyncException {
//            List<String> list = new ArrayList<String>();
//            context.setForceGroupSync(false).setForceUserSync(false);
//            try {
//                Iterator<ExternalUser> iter = idp.listUsers();
//             //   int i=1;
//             //   Iterator<SyncedIdentity> iter1 = handler.listIdentities(userMgr);
//                
//                while (iter.hasNext()) {
//                    ExternalUser user = iter.next();
//                    if (user instanceof ExternalUser) {
//                    User user1 = getAuthorizable(user, User.class);
//               
//                if (user1 == null) {
//                   // if(syncManager.getSyncHandler("default").)
//                   // if(i>1){
//                    try {
...
//				e1.printStackTrace();
//                throw new IllegalArgumentException("Unable to retrieve external users", e1);
//			}*/
//        }
//
//        /**
...
//
//	@Override
//	public String[] syncUsers(String[] userIds, boolean purge, boolean forceGroupSync) {
...
//
//	@Override
//	public String[] syncExternalUsers(String[] externalIds, boolean forceGroupSync) {
//		// TODO Auto-generated method stub
//		return null;
//	}
//
