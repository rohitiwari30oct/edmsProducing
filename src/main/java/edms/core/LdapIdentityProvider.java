...
//     */
//    private LdapConnectionPool userPool;
//
//    /**
//     * user connection factory
//     */
//    private PoolableLdapConnectionFactory userConnectionFactory;
//
//
//    /**
...
//            cc.setCredentials(config.getBindPassword());
//        }
//        userConnectionFactory = new PoolableLdapConnectionFactory(cc);
//        if (config.getUserPoolConfig().getMaxActive() != 0) {
//            userPool = new LdapConnectionPool(userConnectionFactory);
